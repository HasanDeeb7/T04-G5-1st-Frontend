// OurValue.js - File where the OurValue component is defined
...
// OurValue Component Definition
const OurValue = () => {
    return (
        // OurValue Component Container
        <>
            <div className={style.valueSection}>
                {/* Our Value Section */}
                <div className={style.ourValue}>
                    {/* Title of Our Value Section */}
                    <h1 className={style.valueTitle}>our value</h1>
                    {/* Description of Our Value Section */}
                    <p className={style.valueDescription}>
                        We believe in unbiased, gimmick-free, research-backed information.
                        The only thing we endorse is eating unprocessed, whole foods, and working out for a strong, healthy body.
                        As a business, we believe good things happen when you put people before profit.
                    </p>
                </div>

                {/* Value Variants Section */}
